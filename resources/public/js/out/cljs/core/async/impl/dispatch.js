...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15886 = (0);while(true){
var m_15887 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15887 == null))
{} else
{m_15887.call(null);
if((count_15886 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15888 = (count_15886 + (1));
count_15886 = G__15888;
continue;
}
} else
{}
