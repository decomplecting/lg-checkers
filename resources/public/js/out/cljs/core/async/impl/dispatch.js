...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_23385 = (0);while(true){
var m_23386 = cljs.core.async.impl.dispatch.tasks.pop();if((m_23386 == null))
{} else
{m_23386.call(null);
if((count_23385 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__23387 = (count_23385 + (1));
count_23385 = G__23387;
continue;
}
} else
{}
