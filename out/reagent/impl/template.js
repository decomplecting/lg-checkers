...
{return (function() { 
var G__10056__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__10059 = o;(G__10059[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__10059;
}),{},x);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__10060){var vec__10062 = p__10060;var id = cljs.core.nth.call(null,vec__10062,(0),null);var class$ = cljs.core.nth.call(null,vec__10062,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_10063 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_10063 === "key")))
{(o[pname_10063] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__10066 = jsprops;(G__10066["defaultValue"] = value);
(G__10066["value"] = null);
(G__10066["onChange"] = ((function (G__10066,on_change,value){
return (function (p1__10064_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10064_SHARP_);
});})(G__10066,on_change,value))
);
return G__10066;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__10068 = spec;(G__10068["componentDidUpdate"] = ((function (G__10068){
return (function (){var c = this;return reagent.impl.template.input_did_update.call(null,c);
});})(G__10068))
);
(G__10068["componentWillUnmount"] = ((function (G__10068){
...
return (function (p1__10069_SHARP_,p2__10070_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__10069_SHARP_,p2__10070_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__10072 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__10072,(0),null);var id = cljs.core.nth.call(null,vec__10072,(1),null);var class$ = cljs.core.nth.call(null,vec__10072,(2),null);var comp = ((React["DOM"])[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__10074 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__10074,(0),null);var id_class = cljs.core.nth.call(null,vec__10074,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = {"level": level, "argv": v};var k_10075 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__10076 = (((k_10075 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_10075);if((k_SINGLEQUOTE__10076 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__10076);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4510__auto___10077 = a.length;var i_10078 = (0);while(true){
if((i_10078 < n__4510__auto___10077))
{(a[i_10078] = reagent.impl.template.as_component.call(null,(a[i_10078]),level_SINGLEQUOTE_));
{
