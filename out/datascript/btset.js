...
datascript.btset.level_shift = (cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__11607_SHARP_){return ((datascript.btset.max_len & (1 << p1__11607_SHARP_)) != 0);
...
datascript.btset.cut_n_splice = (function cut_n_splice(arr,cut_from,cut_to,splice_from,splice_to,xs){var arr_l = arr.length;var xs_l = xs.length;var l1 = (splice_from - cut_from);var l2 = (cut_to - splice_to);var l1xs = (l1 + xs_l);var new_arr = (new Array(((l1 + xs_l) + l2)));var n__4510__auto___11624 = l1;var i_11625 = (0);while(true){
if((i_11625 < n__4510__auto___11624))
{(new_arr[i_11625] = (arr[(cut_from + i_11625)]));
{
...
var n__4510__auto___11627 = xs_l;var i_11628 = (0);while(true){
if((i_11628 < n__4510__auto___11627))
{(new_arr[(i_11628 + l1)] = (xs[i_11628]));
{
...
var n__4510__auto___11630 = l2;var i_11631 = (0);while(true){
if((i_11631 < n__4510__auto___11630))
{(new_arr[(i_11631 + l1xs)] = (arr[(splice_to + i_11631)]));
{
...
datascript.btset.merge_n_split = (function merge_n_split(a1,a2){var a1_l = a1.length;var a2_l = a2.length;var total_l = (a1_l + a2_l);var r1_l = datascript.btset.half.call(null,total_l);var r2_l = (total_l - r1_l);var r1 = (new Array(r1_l));var r2 = (new Array(r2_l));var n__4510__auto___11633 = total_l;var i_11634 = (0);while(true){
if((i_11634 < n__4510__auto___11633))
{((((i_11634 < r1_l))?r1:r2)[(((i_11634 < r1_l))?i_11634:(i_11634 - r1_l))] = ((((i_11634 < a1_l))?a1:a2)[(((i_11634 < a1_l))?i_11634:(i_11634 - a1_l))]));
{
...
if((level > (0)))
{{
var G__11637 = (level - datascript.btset.level_shift);
var G__11638 = (node.pointers[datascript.btset.path_get.call(null,path,level)]);
level = G__11637;
node = G__11638;
continue;
}
...
datascript.btset.btset_conj = (function btset_conj(set,key){var _STAR_cmp_STAR_11640 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = set.comparator;
...
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_11640;
}});
datascript.btset.btset_disj = (function btset_disj(set,key){var _STAR_cmp_STAR_11642 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = set.comparator;
...
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_11642;
}});
...
var G__11643 = (node.pointers[idx]);
var G__11644 = datascript.btset.path_set.call(null,path,level,idx);
var G__11645 = (level - datascript.btset.level_shift);
node = G__11643;
path = G__11644;
level = G__11645;
continue;
...
var G__11646 = (node.pointers[idx]);
var G__11647 = datascript.btset.path_set.call(null,path,level,idx);
var G__11648 = (level - datascript.btset.level_shift);
node = G__11646;
path = G__11647;
level = G__11648;
continue;
...
var slice__3 = (function (set,key_from,key_to){var _STAR_cmp_STAR_11650 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = set.comparator;
return datascript.btset._slice.call(null,set,key_from,key_to);
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_11650;
}});
...
var ___$1 = this;var _STAR_cmp_STAR_11653 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = self__.comparator;
var or__3640__auto__ = self__.root.lookup(k);if(cljs.core.truth_(or__3640__auto__))
{return or__3640__auto__;
} else
{return not_found;
}
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_11653;
}});
...
return (function (p1__11651_SHARP_){return cljs.core.contains_QMARK_.call(null,this$__$1,p1__11651_SHARP_);
});})(this$__$1))
,other));
});
...
;
datascript.btset.BTSet.prototype.apply = (function (self__,args11652){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args11652)));
});
...
var G__11655__delegate = function (cmp,keys){return cljs.core.reduce.call(null,cljs.core._conj,btset_by.call(null,cmp),keys);
};
var G__11655 = function (cmp,var_args){
var keys = null;if (arguments.length > 1) {
  keys = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__11655__delegate.call(this,cmp,keys);};
G__11655.cljs$lang$maxFixedArity = 1;
G__11655.cljs$lang$applyTo = (function (arglist__11656){
var cmp = cljs.core.first(arglist__11656);
var keys = cljs.core.rest(arglist__11656);
return G__11655__delegate(cmp,keys);
});
...
var G__11657__delegate = function (keys){return cljs.core.reduce.call(null,cljs.core._conj,btset.call(null),keys);
};
var G__11657 = function (var_args){
var keys = null;if (arguments.length > 0) {
  keys = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__11657__delegate.call(this,keys);};
G__11657.cljs$lang$maxFixedArity = 0;
G__11657.cljs$lang$applyTo = (function (arglist__11658){
var keys = cljs.core.seq(arglist__11658);
return G__11657__delegate(keys);
});
