...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_15162 = (0);while(true){
if((i_15162 < arr.length))
{(arr[i_15162] = null);
{
...
{var i_15169 = (self__.level + (1));while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15171 = (0);while(true){
if((i_15171 <= self__.level))
{var links_15172 = (update[i_15171]).forward;if(((links_15172[i_15171]) === x__$1))
{(links_15172[i_15171] = (x__$1.forward[i_15171]));
{
