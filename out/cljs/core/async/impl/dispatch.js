...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15242 = (0);while(true){
var m_15243 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15243 == null))
{} else
{m_15243.call(null);
if((count_15242 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15244 = (count_15242 + (1));
count_15242 = G__15244;
continue;
}
} else
{}
