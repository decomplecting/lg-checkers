...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15248 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15248 = (function (val,box,meta15249){
this.val = val;
this.box = box;
this.meta15249 = meta15249;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t15248.cljs$lang$type = true;
cljs.core.async.impl.channels.t15248.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15248";
cljs.core.async.impl.channels.t15248.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write.call(null,writer__4218__auto__,"cljs.core.async.impl.channels/t15248");
});
cljs.core.async.impl.channels.t15248.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15248.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15250){var self__ = this;
var _15250__$1 = this;return self__.meta15249;
});
cljs.core.async.impl.channels.t15248.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15250,meta15249__$1){var self__ = this;
var _15250__$1 = this;return (new cljs.core.async.impl.channels.t15248(self__.val,self__.box,meta15249__$1));
});
cljs.core.async.impl.channels.__GT_t15248 = (function __GT_t15248(val__$1,box__$1,meta15249){return (new cljs.core.async.impl.channels.t15248(val__$1,box__$1,meta15249));
});
}
return (new cljs.core.async.impl.channels.t15248(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj15252 = {};return obj15252;
})();
...
{}
while(true){
var taker_15253 = self__.takes.pop();if((taker_15253 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15253))
{var take_cb_15254 = cljs.core.async.impl.protocols.commit.call(null,taker_15253);var val_15255 = (cljs.core.truth_((function (){var and__3628__auto__ = self__.buf;if(cljs.core.truth_(and__3628__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3628__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15254,val_15255,taker_15253,this$__$1){
return (function (){return take_cb_15254.call(null,val_15255);
});})(take_cb_15254,val_15255,taker_15253,this$__$1))
);
} else
{}
{
...
{} else
{var putter_15256 = self__.puts.pop();if((putter_15256 == null))
{} else
{var put_handler_15257 = putter_15256.handler;var val_15258 = putter_15256.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15257))
{var put_cb_15259 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15257);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15259,put_handler_15257,val_15258,putter_15256,_,retval,this$__$1){
return (function (){return put_cb_15259.call(null,true);
});})(put_cb_15259,put_handler_15257,val_15258,putter_15256,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_15258)))
...
{var taker_15260 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15260))
{var take_cb_15261 = cljs.core.async.impl.protocols.commit.call(null,taker_15260);var val_15262__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15261,val_15262__$1,taker_15260,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_15261.call(null,val_15262__$1);
});})(take_cb_15261,val_15262__$1,taker_15260,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_15263 = self__.puts.pop();if((putter_15263 == null))
{} else
{var put_handler_15264 = putter_15263.handler;var val_15265 = putter_15263.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15264))
{var put_cb_15266 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15264);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15266,put_handler_15264,val_15265,putter_15263,this$__$1){
return (function (){return put_cb_15266.call(null,true);
...
return (function() {
var G__15271 = null;
var G__15271__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e15269){var t = e15269;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__15271__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e15270){var t = e15270;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__15271 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__15271__1.call(this,buf__$1);
case 2:
return G__15271__2.call(this,buf__$1,val);
}
