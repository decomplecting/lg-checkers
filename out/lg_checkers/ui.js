...
return (function (p1__10642_SHARP_){return lg_checkers.ui.draw_tuple.call(null,p1__10642_SHARP_,row_odd_QMARK_);
});})(curr_row,row_odd_QMARK_))
,row));
});
lg_checkers.ui.checkerboard = (function checkerboard(board,owner){if(typeof lg_checkers.ui.t10646 !== 'undefined')
{} else
{
/**
* @constructor
*/
lg_checkers.ui.t10646 = (function (owner,board,checkerboard,meta10647){
this.owner = owner;
this.board = board;
...
lg_checkers.ui.t10646.cljs$lang$type = true;
lg_checkers.ui.t10646.cljs$lang$ctorStr = "lg-checkers.ui/t10646";
lg_checkers.ui.t10646.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write.call(null,writer__4218__auto__,"lg-checkers.ui/t10646");
});
lg_checkers.ui.t10646.prototype.om$core$IRender$ = true;
lg_checkers.ui.t10646.prototype.om$core$IRender$render$arity$1 = (function (this__4611__auto__){var self__ = this;
...
lg_checkers.ui.t10646.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10648){var self__ = this;
var _10648__$1 = this;return self__.meta10647;
});
lg_checkers.ui.t10646.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10648,meta10647__$1){var self__ = this;
var _10648__$1 = this;return (new lg_checkers.ui.t10646(self__.owner,self__.board,self__.checkerboard,meta10647__$1));
});
lg_checkers.ui.__GT_t10646 = (function __GT_t10646(owner__$1,board__$1,checkerboard__$1,meta10647){return (new lg_checkers.ui.t10646(owner__$1,board__$1,checkerboard__$1,meta10647));
});
}
return (new lg_checkers.ui.t10646(owner,board,checkerboard,null));
});
...
lg_checkers.ui.temporality = (function temporality(){if(typeof lg_checkers.ui.t10652 !== 'undefined')
{} else
{
/**
* @constructor
*/
lg_checkers.ui.t10652 = (function (temporality,meta10653){
...
var _10654__$1 = this;return (new lg_checkers.ui.t10652(self__.temporality,meta10653__$1));
});
lg_checkers.ui.__GT_t10652 = (function __GT_t10652(temporality__$1,meta10653){return (new lg_checkers.ui.t10652(temporality__$1,meta10653));
});
}
return (new lg_checkers.ui.t10652(temporality,null));
});
