...
{{
var G__10042 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10042;
continue;
}
} else
...
{var pred__10046 = cljs.core._EQ_;var expr__10047 = limit;if(cljs.core.truth_(pred__10046.call(null,(1),expr__10047)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10046.call(null,(2),expr__10047)))
...
var G__10049 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10050 = (limit__$1 - (1));
var G__10051 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__10049;
limit__$1 = G__10050;
parts = G__10051;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10053 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10053))
{var replacement_10054 = temp__4124__auto___10053;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10054)));
} else
{buffer.append(ch);
}
{
var G__10055 = (index + (1));
index = G__10055;
continue;
}
}
